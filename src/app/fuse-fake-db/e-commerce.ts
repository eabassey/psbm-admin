export class ECommerceFakeDb {
  ...
  public static products = [
    ...
    },
    {
      ...
      handle: 'brown-shoes',
      description:
        'Aute do cupidatat amet excepteur. Adipisicing est exercitation ullamco velit pariatur ex id laborum ex consectetur velit et eiusmod. Do laborum commodo veniam adipisicing aute cillum. Adipisicing est minim voluptate aliqua nostrud.',
      categories: ['Shoes', 'Women'],
      tags: ['dress', 'printed'],
      images: [
        {
    ...
    },
    {
      ...
      handle: 'night-dress',
      description:
        'Ex culpa et enim aute labore deserunt. Culpa occaecat nostrud culpa elit Lorem deserunt qui nulla ea elit veniam ea. Qui ullamco ullamco minim esse excepteur magna aliquip Lorem tempor ut aliqua sunt ad. Lorem minim tempor aliqua in in. In nisi esse ea eiusmod consequat sint.',
      categories: ['Dresses', 'Women'],
      tags: ['dress', 'printed'],
      images: [
        {
    ...
    },
    {
      ...
      handle: 'red-hoodie',
      description:
        'Aliquip cillum qui in consectetur ullamco ipsum ea esse eu non nostrud cillum velit minim. Deserunt est do non mollit incididunt enim non consectetur dolore ullamco do ad enim aliqua. Velit ipsum duis sunt sint dolore reprehenderit aute sint sunt esse laborum.',
      categories: ['Hoodies', 'Women'],
      tags: ['dress', 'printed'],
      images: [
        {
    ...
    },
    {
      ...
      handle: 'red-hoodie',
      description:
        'Proident excepteur consectetur elit eiusmod ipsum in pariatur voluptate laborum ex ullamco. Nisi cupidatat officia veniam eiusmod enim do aute labore dolor in nostrud sunt pariatur ex. Dolore elit non excepteur sint proident aliqua in aliquip irure elit.',
      categories: ['Hoodies', 'Women'],
      tags: ['dress', 'printed'],
      images: [
        {
    ...
    },
    {
      ...
      handle: 'blouse',
      description:
        'Id dolor sunt deserunt adipisicing nostrud sit enim magna. Eu ut ea qui ullamco aute. Elit do non anim labore culpa aliquip eu ullamco magna aliqua culpa velit. Culpa nisi laboris cupidatat ea in officia est ex.',
      categories: ['Dresses', 'Women'],
      tags: ['dress', 'printed'],
      images: [
        {
    ...
    },
    {
      ...
      handle: 'leather-belt',
      description:
        'Enim adipisicing commodo laboris voluptate minim officia irure aliqua exercitation ad. Laboris in elit culpa aute aliquip ex fugiat enim labore. Ut commodo magna dolore dolore officia exercitation non enim id. Est proident enim incididunt consectetur consequat magna consequat esse veniam ea cillum laboris fugiat incididunt.',
      categories: ['Belts', 'Women'],
      tags: ['dress', 'printed'],
      images: [
        {
          id: 1,
    ...
    },
    {
      ...
      handle: 'leather-belt',
      description:
        'Id et id ad consequat non exercitation laboris enim. Cillum nulla nulla elit ipsum in aliquip culpa fugiat est nulla id adipisicing et. Occaecat aliqua esse dolor aliquip veniam ad amet nisi ipsum. Et aliquip culpa adipisicing Lorem ipsum aute non dolor eu deserunt ex consequat.',
      categories: ['Belts', 'Women'],
      tags: ['dress', 'printed'],
      images: [
        {
