...
import { FuseNavVerticalGroupComponent } from '../nav-group/nav-vertical-group.component';
...
export class FuseNavVerticalCollapseComponent implements OnInit {
  ...
  constructor(
    ...
    @Inject(forwardRef(() => FuseNavVerticalGroupComponent))
    navGroup: FuseNavVerticalGroupComponent,
